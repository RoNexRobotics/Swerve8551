...
public final class Constants {
    public static final class SwerveConstants {
        ...
        public static final double kMaxSpeed = Units.feetToMeters(16.81);
        public static final boolean kMegaTag2Enabled = true;
    }

    public static final class OIConstants {
        public static final int kDriverControllerPort = 0;
        public static final double kDriverControllerTranslationDeadband = 0.05;
        public static final double kDriverControllerRotationDeadband = 0.05;
