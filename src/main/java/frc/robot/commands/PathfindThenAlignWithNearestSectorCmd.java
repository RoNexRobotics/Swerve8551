...
public class PathfindThenAlignWithNearestSectorCmd extends Command {
    ...
    public PathfindThenAlignWithNearestSectorCmd(SwerveSubsystem swerveSubsystem, Transform2d offset) {
